...
pi_archival <- function(data){
  100 - ((length(setdiff(data$Archival.Country, data$PI.Country)) / nrow(data)) * 100)
}

pi_archival2 <- function(data, cohort){
  temp_df <- data %>% filter(Cohort == cohort)
  100 - ((length(setdiff(temp_df$Archival.Country, temp_df$Host.Country)) / nrow(temp_df)) * 100)
}

pi_archival_count <- function(data){
  a <- nrow(data) - length(setdiff(data$Archival.Country, data$PI.Country))
  b <- nrow(data)
  paste0(a, "/", b)
}
...
pi_archival_count2 <- function(data, cohort){
  temp_df <- data %>% filter(Cohort == cohort)
  a <- nrow(temp_df) - length(setdiff(temp_df$Archival.Country, temp_df$Host.Country))
  b <- nrow(temp_df)
  paste0(a, "/", b)
}
...
pi_archival_df <- data.frame("Cohort" = c(c1_prelim$Cohort[1], c2_prelim$Cohort[1], c3_prelim$Cohort[1], 
                             ...
                             "Prelim Percent" = c(pi_archival(c1_prelim), pi_archival(c2_prelim), pi_archival(c3_prelim),
                                                  pi_archival(c4_prelim), pi_archival(c5_prelim), pi_archival(c6_prelim)),
                             "Prelim Count" = c(pi_archival_count(c1_prelim), pi_archival_count(c2_prelim), pi_archival_count(c3_prelim),
                                                pi_archival_count(c4_prelim), pi_archival_count(c5_prelim), pi_archival_count(c6_prelim)),
                             "Detailed Percent" = c(pi_archival(c1_detail), pi_archival(c2_detail), pi_archival(c3_detail),
                                                    pi_archival(c4_detail), pi_archival(c5_detail), pi_archival(c6_detail)),
                             "Detailed Count" = c(pi_archival_count(c1_detail), pi_archival_count(c2_detail), pi_archival_count(c3_detail),
                                                  pi_archival_count(c4_detail), pi_archival_count(c5_detail), pi_archival_count(c6_detail)),
                             "Funded Percent" = c(pi_archival2(funded, 1), pi_archival2(funded, 2), pi_archival2(funded, 3),
                                                  pi_archival2(funded, 4), pi_archival2(funded, 5), pi_archival2(funded, 6)),
                             "Funded Count" = c(pi_archival_count2(funded, 1), pi_archival_count2(funded, 2), pi_archival_count2(funded, 3),
                                                pi_archival_count2(funded, 4), pi_archival_count2(funded, 5), pi_archival_count2(funded, 6)))

pi_archival_df
write.csv(pi_archival_df, "/Users/ShiyuMurashima/Desktop/MEAP-Data-Lab/pi_archival_df.csv", row.names = FALSE)
```
```{r}
100 - ((length(setdiff(c5_prelim$Archival.Country, c5_prelim$PI.Country)) / nrow(unique(c5_prelim$Archival.Country))) * 100)

sort(intersect(c5_prelim$Archival.Country, c5_prelim$PI.Country))
```
...
c5_prelim_same <- data.frame("Cohort 5" = pi_archival_same(c5_prelim))
...
write.csv(c5_prelim_same, "/Users/ShiyuMurashima/Desktop/MEAP-Data-Lab/c5_prelim_same.csv", row.names = FALSE)
...
c4_detail_same <- data.frame("Cohort 4" = pi_archival_same(c4_detail))
c5_detail_same <- data.frame("Cohort 5" = pi_archival_same(c5_detail))
...
write.csv(c4_detail_same, "/Users/ShiyuMurashima/Desktop/MEAP-Data-Lab/c4_detail_same.csv", row.names = FALSE)
write.csv(c5_detail_same, "/Users/ShiyuMurashima/Desktop/MEAP-Data-Lab/c5_detail_same.csv", row.names = FALSE)
...
detail_mat_yes <- mutate(detail_mat_yes, Decision = "Yes")
detail_mat_no <- mutate(detail_mat_no, Decision = "No")
detail_mat <- rbind(detail_mat_yes, detail_mat_no)
prelim_mat_yes <- mutate(prelim_mat_yes, Decision = "Yes")
prelim_mat_no <- mutate(prelim_mat_no, Decision = "No")
prelim_mat <- rbind(prelim_mat_yes, prelim_mat_no)
